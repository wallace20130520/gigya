...
package de.hybris.jgroups.patch.jalo;
...
/**
 * This is the extension manager of the Jgroupspatch extension.
 */
public class JgroupspatchManager extends GeneratedJgroupspatchManager {

    /**
     * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
     */
    private static final Logger LOG = LoggerFactory.getLogger(JgroupspatchManager.class);
     ...
     */
    public static JgroupspatchManager getInstance() {
        return (JgroupspatchManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
                .getExtension(JgroupspatchConstants.EXTENSIONNAME);
    }
     ...
     */
    public JgroupspatchManager() // NOPMD
    {
        LOG.debug("constructor of JgroupspatchManager called.");
    }
    ...
    @Override
    public void init() {
        LOG.debug("init() of JgroupspatchManager called, current tenant: {}", getTenant().getTenantID());
    }
    ...
    @Override
    public void destroy() {
        LOG.debug("destroy() of JgroupspatchManager called, current tenant: {}", getTenant().getTenantID());
    }
