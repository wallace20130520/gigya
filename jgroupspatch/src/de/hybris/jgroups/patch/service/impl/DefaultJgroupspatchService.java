...
package de.hybris.jgroups.patch.service.impl;
...
public class DefaultJgroupspatchService implements JgroupspatchService {

    private static final Logger LOG = LoggerFactory.getLogger(DefaultJgroupspatchService.class);
    ...
    private InputStream getImageStream() {
        return DefaultJgroupspatchService.class.getResourceAsStream("/jgroupspatch/sap-hybris-platform.png");
    }
